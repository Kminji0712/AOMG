...
AOMG 엔터테인먼트의 홈페이지를 리뉴얼 한 사이트입니다.




## 👨‍👧‍👧Team 역할 및 담당
- 김민지(팀장): 디자인 구성 및 컨셉, PPT 제작 // 메인페이지의 section01, 서브페이지의 About, 서브페이지의 Store, Footer 제작
- 이미숙: 자료 조사, 디자인 구성, 자료 취합 // 메인페이지의 Artist, News, 서브페이지의 Schedule, Header, Store 제작
- 장서연: 자료 조사, 디자인 구성 // 메인페이지의 main, about, 서브페이지의 Artist, Artist Sub 제작
